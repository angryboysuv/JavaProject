...
public class Cloths {
	...
	public Cloths() 
	{
		...
		JLabel lblBestAndLuxiourious = new JLabel("BEST AND LUXURIOUS CLOTHINGS FROM ALL OVER THE WORLD");
		lblBestAndLuxiourious.setFont(new Font("Tahoma", Font.PLAIN, 15));
		lblBestAndLuxiourious.setBounds(338, 160, 472, 14);
		...
		lblTextColor.setForeground(new Color(0, 102, 204));
		lblTextColor.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblTextColor.setBounds(575, 376, 198, 22);
		frame.getContentPane().add(lblTextColor);
		
		JLabel lblTextSalesPack = new JLabel("");
		lblTextSalesPack.setForeground(new Color(0, 102, 204));
		lblTextSalesPack.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblTextSalesPack.setBounds(575, 421, 198, 22);
		frame.getContentPane().add(lblTextSalesPack);
		
		JLabel lblTextType = new JLabel("");
		lblTextType.setForeground(new Color(0, 102, 204));
		lblTextType.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblTextType.setBounds(575, 468, 198, 22);
		frame.getContentPane().add(lblTextType);
		...
		JLabel lblNewLabel = new JLabel("CLOTHING");
		...
		panel_1.addMouseListener(new MouseAdapter() 
		{
			...
			public void mouseClicked(MouseEvent arg0) 
			{
				...
				lblNewLabel_1.setIcon(new ImageIcon(Cars.class.getResource("/Project/image/kavaci.png")));
				...
				try
				{
					...
					ResultSet rs=st.executeQuery("select * from scloth where id='"+1+"'");
					...
					{		
						...
						lblTextColor.setText(rs.getString("color"));
						lblTextSalesPack.setText(rs.getString("sales_pack"));
						lblTextType.setText(rs.getString("type"));
		...
		panel_2.addMouseListener(new MouseAdapter() 
		{
			...
			public void mouseClicked(MouseEvent arg0) 
			{
				...
				lblNewLabel_1.setIcon(new ImageIcon(Cars.class.getResource("/Project/image/puma.png")));
				...
				try
				{
					...
					//step 3: Create Statement object
					Statement st=con.createStatement();
					ResultSet rs=st.executeQuery("select * from scloth where id='"+2+"'");
		...
		panel_3.addMouseListener(new MouseAdapter() 
		{
			...
			public void mouseClicked(MouseEvent arg0) 
			{
				...
				lblNewLabel_1.setIcon(new ImageIcon(Cars.class.getResource("/Project/image/blackberry1.png")));
				...
				try
				{
					...
					//step 3: Create Statement object
					Statement st=con.createStatement();
					ResultSet rs=st.executeQuery("select * from scloth where id='"+4+"'");
		...
		panel_4.addMouseListener(new MouseAdapter() 
		{
			...
			public void mouseClicked(MouseEvent arg0) 
			{
				...
				lblNewLabel_1.setIcon(new ImageIcon(Cars.class.getResource("/Project/image/adidas.png")));
		...
		panel_5.addMouseListener(new MouseAdapter() 
		{
			...
			public void mouseClicked(MouseEvent arg0) 
			{
				...
				lblNewLabel_1.setIcon(new ImageIcon(Cars.class.getResource("/Project/image/blackberry2.png")));
				...
				try
				{
					...
					//step 3: Create Statement object
					Statement st=con.createStatement();
					ResultSet rs=st.executeQuery("select * from scloth where id='"+5+"'");
		...
		panel_6.addMouseListener(new MouseAdapter() 
		{
			...
			public void mouseClicked(MouseEvent arg0) 
			{
				...
				try
				{
					...
					//step 3: Create Statement object
					Statement st=con.createStatement();
					ResultSet rs=st.executeQuery("select * from scloth where id='"+6+"'");
					...
					else
					{
						...
						lblTextColor.setText(null);
						lblTextSalesPack.setText(null);
						lblTextType.setText(null);
		...
		panel_7.addMouseListener(new MouseAdapter() 
		{
			...
			public void mouseClicked(MouseEvent arg0) 
			{
				...
				try
				{
					...
					//step 3: Create Statement object
					Statement st=con.createStatement();
					ResultSet rs=st.executeQuery("select * from scloth where id='"+7+"'");
		...
		try
		{
			...
			Statement st=con.createStatement();
				...
				ResultSet r1=st.executeQuery("select * from scloth where id='"+1+"'");
				if(r1.next())
				{		
				...
				ResultSet r2=st.executeQuery("select * from scloth where id='"+2+"'");
				if(r2.next())
				{		
				 ...
				 ResultSet r3=st.executeQuery("select * from scloth where id='"+3+"'");
				if(r3.next())
				{		
					i=1;
				...
				ResultSet r4=st.executeQuery("select * from scloth where id='"+4+"'");
				if(r4.next())
				{		
				...
				ResultSet r5=st.executeQuery("select * from scloth where id='"+5+"'");
				if(r5.next())
				{		
				...
				ResultSet r6=st.executeQuery("select * from scloth where id='"+6+"'");
				if(r6.next())
				{		
				...
				ResultSet r7=st.executeQuery("select * from scloth where id='"+7+"'");
				if(r7.next())
				{		
